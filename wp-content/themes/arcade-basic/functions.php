...
function bavotasan_setup() {
	load_theme_textdomain( 'arcade-basic', BAVOTASAN_THEME_TEMPLATE . '/languages' );
...
function bavotasan_add_js() {
	...
	wp_localize_script( 'arcade-basic-script', 'arcade_basic_vars', array(
		'arc' => absint( $arc_text ),
